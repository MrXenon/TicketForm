...
// 	if (null === $wpdb->get_row("SELECT post_name FROM {$wpdb->prefix}posts WHERE post_name = 'ticketform'", 'ARRAY_A')) {

// 		$current_user = wp_get_current_user();
// 		// Create post object
// 		$page = array(
// 			'post_title' => __('Ticketform'),
// 			'post_content' => '[tickeform_main_view]',
// 			'post_status' => 'publish',
